...
def init_plot(ax2, u0):
    ...
    ax1.set_ylabel('v')
    '''
    sp = ax2.plot_surface(xgrid, ygrid, u0, cmap=cm.coolwarm,
                          linewidth=0, antialiased=False)
    ...
    plt.savefig("Q5_surface_initial_problemsheet6.pdf", format="pdf", bbox_inches="tight")
    plt.draw()
    plt.pause(0.1)
    plt.clf()
...
def update_plot(t, u1):
    ...
    plt.draw()
    plt.savefig("Q5_surface_final_problemsheet6.pdf", format="pdf", bbox_inches="tight")
